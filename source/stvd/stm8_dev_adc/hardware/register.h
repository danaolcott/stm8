...
#define ADC_CR1_START_BIT       BIT_1
...
#define ADC_CR3        *((volatile uint8_t*)0x5342)
#define ADC_SR         *((volatile uint8_t*)0x5343)

#define ADC_DRH        *((volatile uint8_t*)0x5344)
#define ADC_DRL        *((volatile uint8_t*)0x5345)

#define ADC_HTRH       *((volatile uint8_t*)0x5346)
#define ADC_HTRL       *((volatile uint8_t*)0x5347)
#define ADC_LTRH       *((volatile uint8_t*)0x5348)
#define ADC_LTRL       *((volatile uint8_t*)0x5349)

#define ADC_SQR1       *((volatile uint8_t*)0x534A)
#define ADC_SQR2       *((volatile uint8_t*)0x534B)
#define ADC_SQR3       *((volatile uint8_t*)0x534C)
#define ADC_SQR4       *((volatile uint8_t*)0x534D)

#define ADC_TRIGR1     *((volatile uint8_t*)0x534E)
#define ADC_TRIGR2     *((volatile uint8_t*)0x534F)
#define ADC_TRIGR3     *((volatile uint8_t*)0x5350)
#define ADC_TRIGR4     *((volatile uint8_t*)0x5351)
...
#define I2C1_CR1_PE_BIT         BIT_0
#define I2C1_CR2_START_BIT      BIT_0
#define I2C1_CR2_STOP_BIT       BIT_1
