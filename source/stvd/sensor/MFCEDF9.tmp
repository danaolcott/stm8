...
static volatile uint8_t rxIndex1 = 0x00;
static volatile uint8_t rxIndex2 = 0x00;
static volatile uint8_t uartDataReadyFlag1 = 0x00;
static volatile uint8_t uartDataReadyFlag2 = 0x00;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
//Alternate function for parse args
//one that does not use strtok
...
void UART_parseArgs(uint8_t *orig, int* argc, char** argv)
{
    ...
    //loop over the string a second time, this time
    //placing a pointer at the first char of each token
